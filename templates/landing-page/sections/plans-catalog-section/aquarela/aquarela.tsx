...
export const Aquarela = () => {
  return (
    <>
      <PlanCard
        title="Aquarela Iniciante"
        description="Para quem está começando no universo da aquarela. Receba materiais básicos, tutoriais passo a passo e dicas para suas primeiras criações."
        items={[
